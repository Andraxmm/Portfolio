...
export default function Header() {
  ...
  >
    <div className="container-p py-3 flex flex-col gap-3">
      <NavLink href="#home" onClick={() => setOpen(false)}>Inicio</NavLink>
      <NavLink href="#about" onClick={() => setOpen(false)}>Sobre mí</NavLink>
      <NavLink href="#stack" onClick={() => setOpen(false)}>Stack</NavLink>
      <NavLink href="#projects" onClick={() => setOpen(false)}>Proyectos</NavLink>
      <NavLink href="#contact" onClick={() => setOpen(false)}>Contacto</NavLink>

      {/* Botón tema (ajustado al contenido y centrado) */}
      <button
      ...
      {/* Botón CV (ajustado al contenido y centrado) */}
      <a
